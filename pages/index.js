      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">shopnow.com</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Shop the latest anime merchs at the minimum price of ₹499.</p>
          </div>
          ...
          <div className="flex justify-center flex-wrap ">
            ...
            <div className="md:w-1/2 h-[430px] p-4">
              <div className="border hover:bg-gray-100 border-gray-200 p-6 rounded-lg">
                <h2 className="text-xl text-gray-900 text-center mb-6 font-medium title-font mb-2">Anime - Tshirts collection</h2>
            ...
            <div className="md:w-1/2 h-[430px] p-4">
              <div className="border hover:bg-gray-100 border-gray-200 p-6 rounded-lg">
                <h2 className="text-xl text-gray-900 text-center mb-6 font-medium title-font mb-2">Anime - Hoodies collection</h2>
                <div className="inline-flex w-full h-[250px] items-center justify-center mb-4">
            ...
            <div className="md:w-1/2 h-[430px] p-4">
              <div className="border hover:bg-gray-100 border-gray-200 p-6 rounded-lg">
                <h2 className="text-xl text-gray-900 text-center mb-6 font-medium title-font mb-2">Anime - Stickers collection</h2>
                <div className="inline-flex w-full h-[250px] items-center justify-center mb-4">
            ...
            <div className="md:w-1/2 h-[430px] p-4">
              <div className="border hover:bg-gray-100 border-gray-200 p-6 rounded-lg">
                <h2 className="text-xl text-gray-900 text-center mb-6 font-medium title-font mb-2">Anime - Phone cases collection</h2>
                <div className="inline-flex w-full h-[250px] items-center justify-center mb-4">
