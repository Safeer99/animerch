                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex mt-6 justify-between">
                            <button className="flex justify-center w-1/2 mr-10 text-white bg-pink-500 border-0 py-2 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
                            <button onClick={() => addToCart(slug, 1, 499, 'tshirt', 'XL', "red")} className="flex justify-center w-1/2 text-white bg-pink-500 border-0 py-2 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
                        </div>
